...
class PasswordGenerator:
    def __init__(self):
        ...
        self.uppercase_checkbox = tk.Checkbutton(self.window, variable=self.uppercase_var)
        ...
        self.numbers_checkbox = tk.Checkbutton(self.window, variable=self.numbers_var)
        self.numbers_checkbox.grid(row=2, column=1)

        tk.Label(self.window, text="Include Special Characters:").grid(row=3, column=0)
        self.special_var = tk.BooleanVar()
        self.special_checkbox = tk.Checkbutton(self.window, variable=self.special_var)
        self.special_checkbox.grid(row=3, column=1)
